...
def visual(args):
    ...
    if args.arch == "EMDC":
        print("you are using {} model..........".format(args.arch))
    ...
    with torch.no_grad():
        ...
        for pair in pairs:
            ...
            # 预测的结果保存成.exr
            #------------------------------------------------------#
            output_path = os.path.join(args.out_path, exr_dir, exr_name)
        ...
        with open(f'{args.out_path}/data.list', 'w') as f:
            for item in flist:
                f.write("%s\n" % item)
        ...
        with open(f'{args.readme_path}/readme.txt', 'w') as f:
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="yeeluo-EMDC")
    # define model and log path
    parser.add_argument("--arch", required=True, help="Decide the model structure in EMDC / ")
    ...
    # option
    #-------------------------------------------------------#
    # python test.py --arch EMDC --txt_path ./data/validation_input/synthetic/data.list -out_path ./data/validation_input/synthetic/result/ 
    # \--ckp_pat ./model_data/milestone.pth.tar

    # python test.py --arch EMDC --txt_path ./data/validation_input/synthetic/data.list --out_path ./data/validation_input/synthetic/result/ --ckp_pat ./model_data/milestone.pth.tar